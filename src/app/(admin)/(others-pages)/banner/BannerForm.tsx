                                                ...
                                                >
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        ...
                                                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                                                            {product.category?.name ?? "—"} · Stock: {product.variants?.reduce((sum, v) => sum + v.stockQty, 0) ?? 0}
                                                        </p>
                                                    </div>
                            ...
                            <div className="p-5">
                                ...
                                {!selectedProductId || !selectedProduct ? (
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        {(() => {
                                            const totalStock = selectedProduct.variants?.reduce((sum, v) => sum + v.stockQty, 0) ?? 0;
                                            const variantCount = selectedProduct.variants?.length ?? 0;
                                            
                                            // Get unique option values across all variants
                                            ...
                                            return (
                                                <>
                                                    <div className="flex items-center justify-between">
                                                        ...
                                                        <span
                                                            className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${totalStock > 0
