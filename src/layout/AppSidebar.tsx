...
const AppSidebar: React.FC = () => {
  ...
  const userPermissions: string[] = useMemo(() => user?.permissions ?? [], [user]);
      ...
      >
        <Link href="/">
          {logoUrl ? (
              ...
              isExpanded || isHovered || isMobileOpen ? (
                  <div
                      className="h-14 w-[224px] animate-pulse rounded-lg border border-gray-200 bg-gray-200 dark:border-white/[0.08] dark:bg-white/[0.06]"
                  />
              ) : (
                  <div
                      className="h-8 w-8 animate-pulse rounded-md border border-gray-200 bg-gray-200 dark:border-white/[0.08] dark:bg-white/[0.06]"
                  />
              )
          ) : (
              isExpanded || isHovered || isMobileOpen ? (
